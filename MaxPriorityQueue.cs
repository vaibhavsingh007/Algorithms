...
namespace Algorithms
{
    ...
    public class MaxPriorityQueue<TPriority, TValue> : ICollection<KeyValuePair<TPriority, TValue>>
    {
        ...
        public MaxPriorityQueue(int capacity, IComparer<TPriority> comparer)
        {
            if (comparer == null)
        ...
        public MaxPriorityQueue(IEnumerable<KeyValuePair<TPriority, TValue>> data)
        ...
        /// <param name="data">data to be inserted into priority queue</param>
        /// <param name="comparer">priority comparer</param>
        public MaxPriorityQueue(IEnumerable<KeyValuePair<TPriority, TValue>> data, IComparer<TPriority> comparer)
        {
